...
<head>
  ...
  <title>Login Anggota - KIT Madrasah</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
  <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
    <h2 class="text-2xl font-bold mb-6 text-center text-blue-600">Login Anggota</h2>
    <?php if (isset($error)): ?>
      <p class="text-red-600 mb-4 text-center"><?= $error ?></p>
    <?php endif; ?>
    <form action="<?= site_url('auth/anggota_login') ?>" method="POST" class="space-y-6">
      <div>
    ...
    <div class="mt-4 text-center text-gray-600 space-y-2">
      <p>
        Belum menjadi anggota? <a href="<?= site_url('auth/register') ?>" class="text-blue-600 hover:underline">Daftar disini</a>
      </p>
      <p>
        <a href="<?= site_url('auth/admin_login') ?>" class="text-blue-600 hover:underline">Login sebagai Admin</a>
      </p>
    </div>
  </div>
</body>
