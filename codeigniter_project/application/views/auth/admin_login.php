...
<head>
  ...
  <title>Admin Login - KIT Madrasah</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
  <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
    ...
    <?php endif; ?>
    <form action="<?= site_url('auth/admin_login') ?>" method="POST" class="space-y-6">
      <div>
    ...
    <p class="mt-4 text-center text-gray-600">
      Bukan admin? <a href="<?= site_url('auth/anggota_login') ?>" class="text-blue-600 hover:underline">Login sebagai Anggota</a>
    </p>
  </div>
</body>
</html>
